<div wire:ignore.self class="modal fade" id="editSueldosModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="editSueldosModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editSueldosModalLabel">Editar Sueldos y Salarios</h5>
           ...
           <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="actualizarSueldos()" class="btn btn-primary" data-dismiss="modal">Actualizar</button>
            </div>
        </div>
    </div>
</div>